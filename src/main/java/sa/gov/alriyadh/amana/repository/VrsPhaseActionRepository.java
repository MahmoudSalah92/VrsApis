...
public interface VrsPhaseActionRepository extends JpaRepository<VrsPhaseAction, Long> {
    ...
    @Query(value = "SELECT AC.PHASE_ACTION_SERIAL phaseActionId,\n" +
            ...
            "   WHERE    \n" +
            "         AC.CHILD_PHASE_ID = PH_CHILD.PHASE_SERIAL\n" +
    ...
    @Query(value = "SELECT AC.PHASE_ACTION_SERIAL phaseActionId,\n" +
            ...
            "         VRS.VRS_PHASES       PH_CHILD\n" +
            "   WHERE     AC.PARENT_PHASE_ID = PH_PARENT.PHASE_SERIAL\n" +
            "         AND AC.CHILD_PHASE_ID = PH_CHILD.PHASE_SERIAL\n" +
            "         AND PH_CHILD.FROM_ROLE_NO = :role\n" +
            "         AND AC.PHASE_ACTION_SERIAL =:actionId\n" +
            "ORDER BY AC.ACTION_ORDER ASC", nativeQuery = true)
